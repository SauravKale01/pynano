...
bot = Client("accuweather_bot", bot_token="YOUR_TELEGRAM_BOT_TOKEN", api_id=12345, api_hash="YOUR_API_HASH")
...
def help(bot: Client, message: Message):
    ...
    help_text = (
        ...
        "This bot provides the current weather information and api pollution + next 3 to 4 days Whether Info for a location.\n\n"
        "Commands:\n"
